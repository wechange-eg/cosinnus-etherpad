...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Etherpad.description'
        db.add_column(u'cosinnus_etherpad_etherpad', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Etherpad.description'
        db.delete_column(u'cosinnus_etherpad_etherpad', 'description')
