...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Etherpad.special_type'
        db.add_column(u'cosinnus_etherpad_etherpad', 'special_type',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=8, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Etherpad.special_type'
        db.delete_column(u'cosinnus_etherpad_etherpad', 'special_type')
