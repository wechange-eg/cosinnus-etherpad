...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Etherpad.is_container'
        db.add_column(u'cosinnus_etherpad_etherpad', 'is_container',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Etherpad.path'
        db.add_column(u'cosinnus_etherpad_etherpad', 'path',
                      self.gf('django.db.models.fields.CharField')(default=u'/', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Etherpad.is_container'
        db.delete_column(u'cosinnus_etherpad_etherpad', 'is_container')

        # Deleting field 'Etherpad.path'
        db.delete_column(u'cosinnus_etherpad_etherpad', 'path')
