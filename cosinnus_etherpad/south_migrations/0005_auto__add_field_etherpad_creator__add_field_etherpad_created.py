...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Etherpad.creator'
        db.add_column(u'cosinnus_etherpad_etherpad', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cosinnus_etherpad_etherpad_set', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Etherpad.created'
        db.add_column(u'cosinnus_etherpad_etherpad', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Etherpad.creator'
        db.delete_column(u'cosinnus_etherpad_etherpad', 'creator_id')

        # Deleting field 'Etherpad.created'
        db.delete_column(u'cosinnus_etherpad_etherpad', 'created')
